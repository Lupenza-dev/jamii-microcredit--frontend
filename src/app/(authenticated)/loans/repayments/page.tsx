...
export default function LoanRepaymentsPage() {
  return (
    <section
      aria-labelledby="loan-repayments-title"
    ...
    >
      ...
      <div className="mt-8 rounded-xl border border-[#d6dfd8] bg-white p-6 shadow-[0_12px_30px_-25px_rgba(20,35,30,0.45)]">
        <p className="text-sm leading-6 text-[#5c7065]">
          Repayment collection and allocation are outside the current scope.
          This workspace will become available with the repayment module.
        </p>
        <Link
